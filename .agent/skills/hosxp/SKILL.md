...
- **ตารางสถานที่พัก (Hierarchy: Ward -> Room -> Bed):**
  - `ward`: แฟ้มข้อมูลตึกผู้ป่วย (มีฟิลด์ `ward_export_code` สำหรับแมปรหัสมาตรฐาน)
...
- **ข้อมูลทางคลินิกและสถิติ DRG:**
  ...
  - `ipt_nurse_oper`: รายการหัตถการทางการพยาบาล (เชื่อมด้วย `an` และ `ipt_oper_code`)
  - `ipt_oper_code`: Master data รหัสหัตถการผู้ป่วยใน/ทางการพยาบาล
